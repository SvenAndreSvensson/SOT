...
extension Child {
    ...
    static var data:[Child] {[
        Child(id: UUID(uuidString: "14E4F450-4EF0-4B8E-AA8D-A41BE698884A")!, name: "Lee 1", toys: [Toy.data[0], Toy.data[1]]),
        Child(id: UUID(uuidString: "CF62A4EA-B685-44DE-BBC5-9A20A859884D")!, name: "Lee 2", toys: [Toy.data[1]]),
        Child(id: UUID(uuidString: "976AD892-F691-4F42-99B9-CA00605BCFD7")!, name: "Apple 1 ", toys: [Toy.data[2]])
    ]}
